...
public class ThreeDifferentRobotsEmptyMap {
	public static void main(String[] args) throws InterruptedException {
		...
		tec.setForwardModel(2, new ConstantAccelerationForwardModel(1.25*MAX_ACCEL, 1.25*MAX_VEL, tec.getTemporalResolution(), tec.getControlPeriod(), tec.getTrackingPeriod()));
