...
public class TrajectoryEnvelopeTrackerPedestrianOLD extends AbstractTrajectoryEnvelopeTracker implements Runnable {
	...
	public TrajectoryEnvelopeTrackerPedestrianOLD(TrajectoryEnvelope te, int timeStep, double temporalResolution, TrajectoryEnvelopeCoordinator tec, TrackingCallback cb, PedestrianTrajectory pedestrianTraj) {
