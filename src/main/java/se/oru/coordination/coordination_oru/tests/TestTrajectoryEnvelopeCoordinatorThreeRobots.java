...
public class TestTrajectoryEnvelopeCoordinatorThreeRobots {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Missions.pushMission(new Mission(1, prefix+Missions.getPathFile("r1p", "dest1"), Missions.getLocation("r1p"), Missions.getLocation("dest1")));
		Missions.pushMission(new Mission(2, prefix+Missions.getPathFile("r2p", "dest2"), Missions.getLocation("r2p"), Missions.getLocation("dest2")));
		Missions.pushMission(new Mission(3, prefix+Missions.getPathFile("r3p", "dest3"), Missions.getLocation("r3p"), Missions.getLocation("dest3")));
		...
		Missions.pushMission(new Mission(1, prefix+Missions.getPathFile("dest1", "r1p"), Missions.getLocation("dest1"), Missions.getLocation("r1p")));
		Missions.pushMission(new Mission(2, prefix+Missions.getPathFile("dest2", "r2p"), Missions.getLocation("dest2"), Missions.getLocation("r2p")));
		Missions.pushMission(new Mission(3, prefix+Missions.getPathFile("dest3", "r3p"), Missions.getLocation("dest3"), Missions.getLocation("r3p")));
