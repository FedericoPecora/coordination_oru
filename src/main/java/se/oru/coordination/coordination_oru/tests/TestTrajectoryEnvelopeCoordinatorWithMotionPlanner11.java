...
public class TestTrajectoryEnvelopeCoordinatorWithMotionPlanner11 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		tec.setForwardModel(1, new ConstantAccelerationForwardModel(MAX_ACCEL*0.9, MAX_VEL, tec.getTemporalResolution(), tec.getTrackingPeriod()));
		tec.setForwardModel(2, new ConstantAccelerationForwardModel(MAX_ACCEL*0.9, MAX_VEL, tec.getTemporalResolution(), tec.getTrackingPeriod()));
		tec.setForwardModel(3, new ConstantAccelerationForwardModel(MAX_ACCEL*0.9, MAX_VEL, tec.getTemporalResolution(), tec.getTrackingPeriod()));
